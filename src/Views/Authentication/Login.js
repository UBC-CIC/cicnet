...
import TextFieldStartAdornment from "../../Components/Authentication/TextFieldStartAdornment";
import "./Login.css";
import { FormSelect } from '../../Components/Challenges/NewChallenge/InputFields';


const initialFormState = {
    userType: "", email: "", password: "", authCode: "", resetCode: ""
}
...
function Login(props) {
    ...
    async function signUp() {
        try {
            ...
            const {email, password, userType} = formState;
            if (userType !== "SPONSOR") {
                checkEmptyString(formState.given_name);
                checkEmptyString(formState.family_name);
            } else { // if (userType !== "SPONSOR")
                checkEmptyString(formState.name);
            }
                            ...
                            loginState === "confirmSignUp" && (
                                <Grid>
                                    ...
                                    <Grid>
                                        ...
                                        <ResendButton onClick={resendConfirmationCode} size="small">
